        ...
        <div className="text-center text-gray-800">
          ...
          >
            <h1 className="capitalize text-xl md:text-6xl font-bold mb-6 text-white">
             Punjabi <span className="text-[#c02026]">songs lyrics </span>Platform  <br />           
            </h1>
            <p className="text-xl text-white">
              This platform provides a comprehensive collection of lyrics to the latest and popular Punjabi songs.
              {/* song lyrics website that provides access to the lyrics of various songs */}
              </p>
